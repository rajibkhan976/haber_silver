...
class Handler extends ExceptionHandler
{
    ...
    {
        // instance of NotFoundHttpException
        if ($exception instanceof NotFoundHttpException)
        {
            $message = Response::make(['error'=>'not_found','error_message'=>'Please check the URL '], 404);
            return response(view('errors.404', ['message'=>$message]), 404);

        }

        //instance of MethodNotAllowedHttpException
