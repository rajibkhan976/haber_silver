        ...
        <div class="col-sm-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    {{-------------- Filter :Starts -------------------------------------------}}
                    {!! Form::open(['method' =>'GET','route'=>'admin.product.category.search']) !!}
                    <div id="index-search">
                        <div class="col-sm-3">
                            ...
                            @if(isset($data))
                                @foreach($data as $values)
                                    <tr class="gradeX">
                                        ...
                                        <td>{{$values->status}}</td>
                                        <td>
                                            <a href="{{ route('admin.view.product.category.details', $values->id) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                                            <a href="{{ route('admin.edit.product.category', $values->id) }}" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#etsbModal" data-placement="top" data-content="update"><i class="fa fa-edit"></i></a>
                                            @if( $values->status !="cancel")
                                                <a href="{{ route('admin.delete.product.category', $values->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" data-placement="top" data-content="delete"><i class="fa fa-trash-o"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content add-form">
                ...
                <div class="modal-body">
                     ...
                     {!! Form::open(['route' => 'admin.store.product.category', 'method'=>'POST', 'files'=>true, 'id' => 'user-jq-validation-form', "class"=>"form form-validate floating-label",  "novalidate"=>"novalidate", "enctype" => "multipart/form-data" ]) !!}
