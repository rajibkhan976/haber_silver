            ...
            <div class="panel">
                <div class="panel-heading">
                    ...
                    <span style="color: #A54A7B " class="top-popover" rel="popover" data-title=" {{ $pageTitle }}"
                          data-html="true"
                          data-content="<em>we can show all page content in this page</em>"> (?) </span>
                    <a class="btn btn-primary btn-xs pull-right pop" data-toggle="modal" href="#addData"
                       data-placement="top"
                       data-content="click add page content service button for new image slider entry">
                        <strong>Add Page Content</strong>
                    </a>
                </div>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                            ...
                            <tr>
                                ...
                                <th> Action &nbsp;&nbsp;<span style="color: #A54A7B " class="top-popover" rel="popover"
                                                              ...
                                                              data-content="view : click for details informations<br>update : click for update informations<br>delete : click for cancel page content"> (?) </span>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content add-form">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Add Page Content<span style="color: #A54A7B"
                ...
                <div class="modal-body">
                    ...
                    {!! Form::open(['route' => 'admin.store.page.content','id' => 'user-jq-validation-form', "class"=>"form form-validate floating-label",  "novalidate"=>"novalidate", "enctype" => "multipart/form-data" ]) !!}

                    @include('admin::page_content._form')
                    {!! Form::close() !!}
                </div> <!-- / .modal-body -->
            </div> <!-- / .modal-content -->
        </div> <!-- / .modal-dialog -->
