            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">{{ $pageTitle }}</span>&nbsp;&nbsp;&nbsp;
                     <span style="color: #A54A7B " class="top-popover" rel="popover" data-title=" {{ $pageTitle }}" data-html="true" data-content="<em>we can show all trade show in this page</em>"> (?) </span>
                    <a class="btn btn-primary btn-xs pull-right pop" data-toggle="modal" href="#addData" data-placement="top" data-content="click add trade show button for new trade show entry"  >
                        <strong>Add Trade Show Item</strong>
                    </a>
               </div>
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            @if( $values->status !="cancel")
                                                <a href="{{ route('admin.delete.trade.show', $values->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" data-placement="top" data-content="delete"><i class="fa fa-trash-o"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content add-form">
                ...
                <div class="modal-body">
                     ...
                     {!! Form::open(['route' => 'admin.store.trade.show','id' => 'user-jq-validation-form', "class"=>"form form-validate floating-label",  "novalidate"=>"novalidate", "enctype" => "multipart/form-data" ]) !!}
                    
                     @include('admin::trade_show._form')
                    {!! Form::close() !!}
                </div> <!-- / .modal-body -->
            </div> <!-- / .modal-content -->
        </div> <!-- / .modal-dialog -->
