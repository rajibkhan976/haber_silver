        ...
        <div class="col-sm-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    {{-------------- Filter :Starts -------------------------------------------}}
                    {!! Form::open(['method' =>'GET', 'route' => 'user.role.search']) !!}
                            ...
                            @if(isset($data))
                                @foreach($data as $values)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href="{{ route('user.view.role', $values->slug) }}" class="btn btn-info btn-xs" data-placement="top" data-toggle="modal" data-target="#etsbModal" data-content="view"><i class="fa fa-eye"></i></a>
                                            <a href="{{ route('user.edit.role', $values->slug) }}" class="btn btn-primary btn-xs" data-placement="top" data-toggle="modal" data-target="#etsbModal" data-content="update"><i class="fa fa-edit"></i></a>
                                            <!-- <a href="{{ route('user.delete.role', $values->slug) }}" class="btn btn-danger btn-xs" data-placement="top" onclick="return confirm('Are you sure to Delete?')" data-content="delete"><i class="fa fa-trash-o"></i></a> -->
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
    ...
    <div id="addData" class="modal fade" tabindex="" role="dialog" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content add-form">
                ...
                {!! Form::open(['route' => 'user.store.role', 'id' => 'user-jq-validation-form', "class"=>"form form-validate floating-label",  "novalidate"=>"novalidate" ]) !!}
