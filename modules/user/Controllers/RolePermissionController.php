...
class RolePermissionController extends Controller
{
     ...
     */
    public function search_permission_role(Route $route)
    {
        $pageTitle = "Role based Permission :: Lists";

        $q_title = Input::get('title');
    ...
    public function store(Requests\RolePermissionRequest $request)
    {
        ...
        {
            $permission_exists = RolePermission::where('permissions_id','=',$p_id)->where('roles_id','=',$input['roles_id'])->exists();
        ...
        return redirect()->route('user.index.permission.role');
